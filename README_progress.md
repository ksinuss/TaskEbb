...
1. **Оформленное README проекта (описание, как локально развернуть, картинки/графики/выводы) - 1 балл**

2. **Структурированный проект на уровне директорий (не все файлы в одной папке) - 1 балл**

3. **Документация (подробное описание логики, структуры кода, описание классов/методов) - 3 балла**

4. **Применение ООП - 3 балла**

5. **Написание тестов - 3 балла**
...
4. **Интеграция со сторонним API - 5 баллов**  
   Интеграция с Telegram API.

5. **Если C++, использование сторонних фреймворков/библиотек - 10 баллов**
   Использование библиотеки Qt для создания графического интерфейса.
...
- [x] Добавление, интеграция шаблонов задач
- [x] Доработка Telegram-бота (interaction, shared bot)
- [x] Финальное тестирование
- [x] Оформление документации и README
